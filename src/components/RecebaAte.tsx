...
export default function RecebaAte({ valor, etapaAtual = 1 }: PropsRecebaAte) {
    ...
    return (
        <div className="flex items-center justify-between h-[44px] px-[18px] py-2 border-t border-[#E6E6E6] bg-white/95 backdrop-blur-sm lg:px-4 lg:rounded-[8px] lg:bg-[#E0F2F1] lg:border-t-0">
