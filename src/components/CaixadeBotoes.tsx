...
export default function CaixadeBotoes({ etapaAtual, aoMudarEtapa }: PropsCaixadeBotoes) {
    ...
    if (etapaAtual === 1) {
        return (
            <div className="fixed bottom-0 left-0 right-0 z-10 lg:static w-full lg:w-[640px] h-[72px] lg:h-[70px] flex flex-row items-center justify-between lg:justify-end border-t border-[#E2E2E2] lg:border-t-[#FFFFFF] border-t-[1px] gap-4 lg:mt-0 mt-auto bg-white p-4 lg:p-0">
    ...
    if (etapaAtual === 4) {
        return (
            <div className="fixed bottom-0 left-0 right-0 z-10 lg:static w-full lg:w-[640px] h-[72px] lg:h-[70px] flex flex-row items-center justify-between border-t border-[#E2E2E2] lg:border-t-[#FFFFFF] border-t-[1px] gap-4 lg:mt-0 mt-auto bg-white p-4 lg:p-0">
